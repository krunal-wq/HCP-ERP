...
from core.permissions import get_perm, get_sub_perm, get_grid_columns, save_grid_columns, require_perm, require_sub_perm
from core.audit_helper import audit, snapshot, diff
...
def contribution_config():
    ...
    from core.permissions import get_sub_perm
    if not get_sub_perm('crm', 'points_config'):
