...
# â”” Auth key â” PHP push_to_live() mein jo Authorization header hai â””
...
def receive_logs():
    ...
    # â”” DEBUG: log incoming request basics â””
    sys.stderr.write(f"\n========== RECEIVE_LOGS DEBUG ==========\n")
    ...
    # â”” DEBUG: dump first 2 entries' structure â””
    ...
    # â”” Extended key list â” alag alag biometric brands ke saath compatible â””
    ...
    # â”” attendance table update â” SKIPPED in receive_logs â””
...
# â”” Default employees (9001 & 9002) â” admin / management staff jo
...
# â”” Week-off rule: HCP OFFICE = Sunday off; baki sab = Tuesday off â””
...
def _sync_one_date(target_date):
    ...
    # â”” Step 1: Us din ke saare punches ek hi query me lao â””
    ...
    # â”” Step 2: Saare employees ek hi query me lao â””
    ...
    # â”” Step 3: Us date ke saare existing attendance records lao â””
    ...
    # â”” Step 4: Process each employee with punches â””
    ...
    # â”” Step 5: Default employees (9001/9002) â” existing_atts dict use karo â””
...
# â”” Sync POST endpoint â” date range process karta hai â””””””””””””””””
...
# â”” Fetch-from-device API (manual trigger) â””””””””””””””””””””””””””””
