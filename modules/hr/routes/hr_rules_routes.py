"""
hr_rules_routes.py â€” HR Rules Pages
Blueprint: hr_rules at /hr/rules

Covers:
  /hr/rules/shifts          â€” Shift Master
  /hr/rules/locations       â€” Location Master
  /hr/rules/early-going     â€” Early Going Rules
  /hr/rules/overtime        â€” Overtime Rules
  /hr/rules/leave-policy    â€” Leave Policy
  /hr/rules/lop             â€” Loss of Pay Rules
  /hr/rules/absent          â€” Absent Penalty Rules
  /hr/rules/comp-off        â€” Comp Off Rules
"""
...
def shifts():
    ...
    if request.method == 'POST':
        ...
        if action == 'add':
            ...
            db.session.commit()
            flash(f'Shift "{s.name}" {"activated" if s.is_active else "deactivated"}.', 'success')
