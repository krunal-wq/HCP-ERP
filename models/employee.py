"""
models/employee.py â€” Employee & Contractor models
"""
...
class Contractor(db.Model):
    """Contractor master â€” matches provided DB schema"""
    ...
    # â”€â”€ Document Numbers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ Document File Paths (stored in static/uploads/contractors/) â”€â”€
    ...
    # â”€â”€ New contractor registrations (number + file) â”€â”€
    ...
    # â”€â”€ Other / Extra Documents (JSON list) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class Employee(db.Model):
    ...
    qr_code_base64  = db.Column(db.Text(16777215))   # MEDIUMTEXT â€” base64 QR image
    ...
    profile_photo   = db.Column(db.Text(16777215))   # MEDIUMTEXT â€” base64 photo
    ...
    bank_proof_base64   = db.Column(db.Text(16777215))   # MEDIUMTEXT â€” base64 of cancelled-cheque/passbook copy
    ...
    prev_salary_per_month = db.Column(db.Numeric(12, 2))   # â‚¹ / month at previous company

    # Documents (JSON list of {name, type, filename, base64, uploaded_at})
    documents_json      = db.Column(db.Text(16777215))   # MEDIUMTEXT â€” base64 docs

    # â”€â”€â”€ Phase-1: Family / Contact â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€â”€ Phase-1: Permanent Address â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€â”€ Phase-1: Grade / Probation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€â”€ Phase-1: PF â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€â”€ Phase-1: ESIC â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€â”€ Phase-1: TDS / Tax â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€â”€ Phase-1: Statutory â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€â”€ Phase-1: Attendance / Leave â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€â”€ Phase-1: System Access â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    official_email = db.Column(db.String(150))
    role_access    = db.Column(db.String(100))

    # â”€â”€â”€ Phase-1: Exit extras â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€â”€ Phase-1: Salary extras (HR-only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€â”€ Soft delete â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class WishLog(db.Model):
    """Track who wished whom today â€” prevent duplicate notifications."""
...
# â”€â”€ Salary Config â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class SalaryConfig(db.Model):
    ...
    _DEFAULTS = {
        ...
        # â”€â”€â”€ HCP Salary Policy Rules (Phase 7) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        'hcp_enabled':             '1',       # 1 = use HCP rules, 0 = use legacy CTC calc
        'hcp_high_gross_thresh':   '30000',   # Gross >= this uses "high" rules
        'hcp_esic_limit':          '21000',   # Gross <= this â†’ ESIC applies (HO only)
...
# â”€â”€ Salary Component â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

class SalaryComponent(db.Model):
    """Dynamic salary components â€” earnings, deductions, employer contributions."""
...
class EmployeeTypeMaster(db.Model):
    """Employee Type Master â€” HCP OFFICE, HCP FACTORY STAFF, etc."""
...
class NationalityMaster(db.Model):
    """Nationality Master â€” Indian, American, British, etc."""
...
class QualificationMaster(db.Model):
    """Qualification Master â€” 10th, 12th, B.E/B.Tech, MBA, B.Pharm, etc."""
...
class GradeMaster(db.Model):
    """
    Grade Master â€” J1, J2, J3, M1-M3, S1-S3, MG1-MG3 etc.

    Structure (image ke according):
      grade_level     â†’ Junior / Mid / Senior / Management
      grade_code      â†’ J1, J2, M1, MG1 ...   (UNIQUE)
      grade_positions â†’ comma-separated job titles
                         (e.g. "Trainee, Assistant")
      remarks         â†’ per-level note
...
class EmployeeLocationMaster(db.Model):
    """Employee Location/Branch Master â€” Office, Factory, etc."""
...
class DepartmentMaster(db.Model):
    """Department Master â€” Sales, HR, IT, etc."""
...
class DesignationMaster(db.Model):
    """Designation Master â€” Manager, Executive, etc."""
...
class CountryMaster(db.Model):
    """Country Master â€” India, USA, UK, etc."""
...
class StateMaster(db.Model):
    """State / Province Master â€” Gujarat (GJ, 24), Maharashtra (MH, 27), etc."""
