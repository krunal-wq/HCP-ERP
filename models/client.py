"""
models/client.py  â€”  ClientMaster, ClientAddress, ClientBrand
"""
...
class ClientMaster(db.Model):
    ...
    # These columns already exist in DB â€” keeping them
    ...
    def __repr__(self):
        return f'<ClientMaster {self.code} â€” {self.contact_name}>'
