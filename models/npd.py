...
Product Development Workflow (NPD) Models:
  - NPDProject        â†’ Main project record (NPD or Existing Product path)
  - MilestoneMaster   â†’ Milestones checklist per project
  - MilestoneLog      â†’ History/updates per milestone
  - NPDFormulation    â†’ R&D formulation & sampling loop
  - NPDSampleLog      â†’ Sample send/reject/approve history
  - NPDPackingMaterial â†’ Packing material tracking
  - NPDArtwork        â†’ Artwork & design process
  - NPDActivityLog    â†’ Auto timeline for project
"""
...
class NPDProject(db.Model):
    ...
    # Status flow
    # npd: lead_created â†’ npd_form â†’ formulation â†’ client_approved â†’ commercial â†’ milestones â†’ complete/cancelled
    # existing: lead_created â†’ sample_sent â†’ client_review â†’ commercial â†’ milestones â†’ complete/cancelled
    ...
    # When the NPD fee checkbox first flipped from unchecked â†’ checked. Used
    ...
    # Advance payment (â‚¹2k for Existingâ†’NPD conversion)
    ...
    def status_label(self):
        ...
        # fallback
        return self.status.replace('_', ' ').title() if self.status else 'â€”'
    ...
    def __repr__(self):
        return f'<NPDProject {self.code} â€” {self.product_name}>'
...
class MilestoneMaster(db.Model):
    ...
    @property
    def status_icon(self):
        return {'pending':'â³','in_progress':'ðŸ”„','approved':'âœ…',
                'rejected':'âŒ','skipped':'â­ï¸'}.get(self.status,'â³')
...
class NPDPackingMaterial(db.Model):
    ...
    # â”€â”€ Filling related fields (added) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class NPDActivityLog(db.Model):
    ...
    def __repr__(self):
        return f'<NPDActivityLog project={self.project_id} â€” {self.action[:40]}>'
...
class NPDMilestoneTemplate(db.Model):
    ...
    def __repr__(self):
        return f'<NPDMilestoneTemplate {self.milestone_type} â€” {self.title}>'


# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# Office Dispatch Token  (Sample Ready â†’ Send to Office)
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class OfficeDispatchItem(db.Model):
    ...
    handover_to  = db.Column(db.String(200), nullable=True)   # free text â€” person name
    submitted_by = db.Column(db.String(200), nullable=True)   # free text â€” person name

    # â”€â”€ Link back to the R&D sub-assignment (when dispatched from R&D Sample Log)
    ...
    # â”€â”€ Sample Approval (post-dispatch review)
    ...
    # â”€â”€ Client Dispatch (post-approval â€” sent to client)
...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# R&D Project Log  â€” project-wise start/stop/assign events
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# RD Sub Assignment â€” 1 project â†’ multiple executives, each independent
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
class RDSubAssignment(db.Model):
    ...
    # â”€â”€ Send-to-Office workflow (added) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    # `status` can additionally take: 'sent_to_office'
    # Lifecycle: not_started â†’ in_progress â†’ finished â†’ sent_to_office
    #                                          â†‘  (revert returns here)
...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# RD Trial Log â€” purpose-built table for R&D trial logging
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# project + sample_code + user + parameters + notes â€” no status
...
#   `rd_user_id` is the live FK to users â€” query/filter by this.
#   `rd_user_name` is the snapshot at insert time â€” display this so
...
class RDTrialLog(db.Model):
    ...
    # Relationships â€” eager loading off, opt in via .options(joinedload(...))
...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# Sample Approval Log â€” audit trail for approve/reject/reset
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# ClientDispatch â€” "Send Approved Samples to Client" workflow
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
