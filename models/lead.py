...
Lead CRM models:
  - Lead             â†’ main lead record
  - LeadDiscussion   â†’ comments / discussion board
  - LeadAttachment   â†’ files uploaded to lead / discussion
  - LeadReminder     â†’ follow-up reminders
  - LeadNote         â†’ private personal notes per user
  - LeadActivityLog  â†’ auto activity timeline
"""
...
class Lead(db.Model):
    ...
    # â”€â”€ Existing DB columns (matching your original database) â”€â”€
    ...
    # â”€â”€ New columns (added via migration) â”€â”€
    ...
    # â”€â”€ Backward-compat properties (templates mein l.name etc. kaam karte hain) â”€â”€
    @property
    def name(self):
    ...
    def __repr__(self):
        return f'<Lead {self.code} â€” {self.contact_name}>'
...
class LeadActivityLog(db.Model):
    ...
    def __repr__(self):
        return f'<LeadActivityLog lead={self.lead_id} â€” {self.action[:30]}>'
