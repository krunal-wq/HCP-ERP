...
Purani 'customers' table ke liye â€” delete mat karo,
...
class Customer(db.Model):
    ...
    def __repr__(self):
        return f'<Customer {self.code} â€” {self.contact_name}>'
...
class CustomerAddress(db.Model):
    ...
    def __repr__(self):
        return f'<CustomerAddress {self.address_type} â€” {self.customer_id}>'
