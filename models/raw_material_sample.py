...
Raw Material Sample Request module â€” used by NPD / R&D teams to
request sample raw materials from the Purchase department.

Workflow:
    request_created   â†’ NPD / R&D creates request
    sent_to_purchase  â†’ Auto on create (visible to Purchase dept)
    supplier_finalizedâ†’ Purchase team picks a supplier
    order_placed      â†’ Purchase team places order with supplier
    order_dispatched  â†’ Purchase team enters courier / tracking
    sample_received   â†’ NPD / R&D confirms physical receipt
...
# â”€â”€ ALLOWED STATUS VALUES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
RMS_STATUSES = (
    'request_created',
    'sent_to_purchase',
    'supplier_finalized',
...
class RawMaterialSampleRequest(db.Model):
    ...
    # â”€â”€ REQUEST PART (filled by NPD / R&D) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ PURCHASE PART (filled by Purchase team) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ DISPATCH PART (filled by Purchase team after supplier ships) â”€
    ...
    # â”€â”€ RECEIPT PART (filled by NPD / R&D when material arrives) â”€â”€â”€â”€â”€
    ...
    # â”€â”€ STATUS & META â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ RELATIONSHIPS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Notification queue (optional â€” used by routes) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
class RMSNotification(db.Model):
    ...
    Rendering UI is optional â€” just reading the rows is enough for
