"""
models/permission.py â€” Role-based Permission System
"""
...
class RolePermission(db.Model):
    """Permission matrix: role Ã— module Ã— actions"""
...
class UserPermission(db.Model):
    ...
    ko override karta hai â€” user-specific granular access control.
    """
    ...
    # Sub-permissions â€” JSON dict of granular flags
