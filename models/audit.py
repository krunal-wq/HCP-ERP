"""
models/audit.py â€” Central Audit Log
...
class AuditLog(db.Model):
    ...
    username     = db.Column(db.String(100))          # snapshot â€” survives user delete
    ...
    record_label = db.Column(db.String(300))          # human readable â€” "LD-0032 / Rahul Yadav"
    # Detail
