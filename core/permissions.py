...
#  Fetch permission for current user â”€
...
#  Material-category (RM/PM/FG) view permission â€” shared, reusable 
...
DEFAULT_MODULES = [
    ...
    {'name':'crm_setting','label':'CRM Settings','icon':'\u2699','url_prefix':'/crm/settings','sort_order':9,'parent':'crm'},
...
def seed_permissions():
    ...
    #  Reconcile structure on EXISTING rows 
