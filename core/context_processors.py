...
=====================
Flask Context Processors â€” Har template mein automatically available variables inject karta hai.
...
def register_context_processors(app):
    ...
    def inject_nav_modules():
        """
        nav_modules â€” Sidebar ke liye sirf ACTIVE modules inject karta hai.
        ...
        try:
            # Sirf active modules â€” parent aur children dono
            active_modules = (
                Module.query
            ...
            # DB error hone par empty list â€” app crash na ho
            return {'nav_modules': []}
