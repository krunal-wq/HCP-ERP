...
def permissions():
    ...
    System is now user-only â€” har user ko individually permission do.
...
def profile():
    ...
    if not emp:
        ...
        # (b) Still nothing â€” auto-create minimal employee record
        if not emp:
            ...
            first = parts[0]
            last  = parts[1] if len(parts) > 1 else 'â€”'

            emp = Employee(
                employee_code = emp_code,
                first_name    = first,
                last_name     = last,
                mobile        = '0000000000',    # placeholder â€” user can edit
    ...
    if request.method == 'POST':
        ...
        # Full profile save â€” mirrors hr.emp_edit field-for-field
        # â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
        ...
        if emp:
            ...
            # Employee ID (Biometric / Device) â€” uniqueness check
            ...
            # Salary â€” READ-ONLY from Profile page (security).
            ...
            # â”€â”€ Phase-1: Family / Contact â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ Phase-1: Permanent Address â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ Phase-1: Grade / Probation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ Phase-1: Salary extras (READ-ONLY â€” HR only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            # emp.salary_conveyance, emp.salary_bonus, emp.salary_incentive, emp.salary_gross
            # NOT updated from profile page. See Salary block above for rationale.

            # â”€â”€ Phase-1: PF â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ Phase-1: ESIC â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ Phase-1: TDS / Tax â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ Phase-1: Statutory â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ Phase-1: Attendance / Leave â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ Phase-1: System Access â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            emp.official_email = request.form.get('official_email', '').strip() or None

            # â”€â”€ Phase-1: Exit extras â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # GET â€” load dropdown data same as emp_edit
...
def audit_logs():
    ...
    # Stats â€” last 30 days action counts
...
def acp_panel(user_id=None):
    """Access Control Panel â€” split panel design.
    ...
    # â”€â”€ Build user_id â†’ Employee map (single query, efficient) â”€â”€
...
def user_permissions(user_id):
    ...
    if request.method == 'POST':
        ...
        if action == 'reset':
            ...
            db.session.commit()
            flash(f'{u.full_name} ke sab permissions reset kar diye gaye â€” ab koi access nahi.', 'success')
            ...
            # â”€â”€ Auto-enable parents of every enabled child â”€â”€
            # Agar user ke pass child module ka can_view=True hai lekin parent
            # disabled hai, to sidebar me parent nahi dikhega â†’ child bhi nahi
    ...
    # GET â€” load existing user permissions
    perm_map = {}  # module_id â†’ UserPermission
    for up in UserPermission.query.filter_by(user_id=user_id).all():
        perm_map[up.module_id] = up

    # Build sub_perm_map: module_id â†’ {key: bool}
    sub_perm_map = {}
...
def user_perm_toggle(user_id):
    """AJAX toggle â€” single permission on/off."""
    data      = request.json
    ...
    if not up:
        ...
        # Naya record â€” sub_perms sab True set karo by default
    ...
    if action in ('can_view', 'can_add', 'can_edit', 'can_delete', 'can_export', 'can_import'):
        # Admin ka can_view kabhi False nahi hoga â€” warna apna hi module band ho jaata hai
        ...
        # Agar child ka can_view = True kiya â†’ parent ko bhi auto-enable karo
        if action == 'can_view' and value:
            ...
            if mod and mod.parent_id:
                ...
                if not parent_up:
                    # Parent record exist nahi karti â†’ create karke can_view=True set karo
    ...
    # Module Enable/Disable ALL â€” sare permissions ek saath on/off
    if action == 'disable_all':
        ...
        if mod:
            ...
            # â”€â”€ Child modules bhi cascade karo (e.g. CRM â†’ crm_leads, crm_clients) â”€â”€
            child_modules = Module.query.filter_by(parent_id=module_id, is_active=True).all()
            for child in child_modules:
                affected_module_ids.append(child.id)
        ...
        up.updated_by = current_user.id
        db.session.commit()
        return jsonify({'ok': True, 'value': value, 'affected_module_ids': affected_module_ids})
