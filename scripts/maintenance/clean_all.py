...
â•‘                FULL DATA CLEAN SCRIPT                            â•‘
â•‘  Run:  python clean_all.py                                       â•‘
â•‘  âœ…  SAFE  â€” Users, Employees RAKHE JAAYENGE                     â•‘
â•‘  âŒ  DELETE â€” Baaki sab data                                     â•‘
...
def info(m): print(f"  {C}â„¹ï¸  {m}{E}")

print(f"\n{'='*55}")
print(f"  {R}{B}WARNING: FULL DATA CLEAN â€” PERMANENT DELETE{E}")
print(f"{'='*55}")
