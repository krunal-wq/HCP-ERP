...
# -------------------------------------------------------------------------------------
"""
check_project_milestones.py â€” Specific project ke milestones DB state dikhata hai
...
with app.app_context():
    ...
    if not proj:
        print(f"âŒ Project not found: {arg}")
        sys.exit(1)

    print(f"\n{'='*70}")
    print(f"  PROJECT: {proj.code} â€” {proj.product_name}")
    ...
    print("â”€â”€ Current Template Master (NPDMilestoneTemplate) â”€â”€")
    ...
    print(f"â”€â”€ MilestoneMaster rows for this project â”€â”€")
    ...
    print(f"\n   â†’ {sel_count} rows with is_selected=True  (yeh Milestones tab me dikhega)")
    print()
