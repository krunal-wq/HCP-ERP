...
INSERT IGNORE INTO salary_config (`key`, value, label) VALUES
  ...
  ('ta_fixed',     '1600',  'Transport Allow. Fixed â‚¹'),
  ('med_fixed',    '1250',  'Medical Allow. Fixed â‚¹'),
  ...
  ('esic_limit',   '21000', 'ESIC Applicable Gross Limit â‚¹'),
  ('pt_fixed',     '200',   'Professional Tax Fixed â‚¹/month');
"""
...
with app.app_context():
    ...
    db.session.commit()
    print("âœ… salary_config table created and seeded!")
