...
=================================
One-time migration â€” wires the "Raw Material Sample Request" module
into the running app:

    1. Creates two new DB tables
        â€¢ raw_material_sample_requests
        â€¢ rms_activity_log
        â€¢ rms_notifications
...
Idempotent â€” running it again is safe.
"""
...
print(f"\n{'=' * 60}")
print(f"  {B}RAW MATERIAL SAMPLE REQUEST â€” MODULE MIGRATION{E}")
print(f"{'=' * 60}")
...
with app.app_context():
    ...
    # â”€â”€ STEP 1: Create tables (no-op if they already exist) â”€â”€â”€â”€â”€â”€â”€â”€
    try:
        db.create_all()
        ok("Tables synced â€” raw_material_sample_requests, rms_activity_log, rms_notifications")
    except Exception as e:
        err(f"DB create_all failed: {e}")
        sys.exit(1)

    # â”€â”€ STEP 2: Top-level module (root) â€” same as Packing â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ STEP 3: Create / update Module row â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ STEP 4: Seed default role permissions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    print(f"\n{'=' * 60}")
    print(f"  {G}{B}âœ… DONE{E}")
    print(f"{'=' * 60}")
    print(f"  Next steps:")
    print(f"    1. Restart the Flask app")
    print(f"    2. Open ACP (/admin/acp) â†’ grant 'Raw Material Sample'")
